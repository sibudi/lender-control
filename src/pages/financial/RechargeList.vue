<template>
 ...
 <!--          <template slot-scope="scope">
            <span>{{getUnixTime(scope.row.buildTime)}}</span>
          </template> -->
        </el-table-column>
        ...
        <el-table-column label="Waktu Transaksi" prop="payTime">
<!--           <template slot-scope="scope">
            <span>{{getUnixTime(scope.row.payTime)}}</span>
          </template> -->
        </el-table-column>
      </el-table>
    </template>
...
// WEBPACK FOOTER //
// src/pages/financial/RechargeList.vue