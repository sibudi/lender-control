...
const routes = [{
  ...
  },
  {
    ...
    name:'Manajemen Aset Super Investor',
    path:'/SuperAccManage',
    component:resolve => require(['../pages/financial/SuperManage.vue'], resolve),
  },{
    name:'Manajemen Aset Institusional',
    path:'/UserAccManage',
